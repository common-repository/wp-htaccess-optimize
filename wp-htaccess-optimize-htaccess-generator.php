 ...
 * --- -
 * php_value date.timezone %1$s
 */
function wpho_get_time_zone_selection() {
    $gmt_offset = get_option( 'wpho_country_selected_htaccess' );
    if( -11 <= $gmt_offset || 12 >= $gmt_offset ) {
        ...
        switch( $gmt_offset ) {
            ...
            case 11:
                ...
                break;
            default:
                $timezone_name = timezone_name_from_abbr( "Europe/London", $gmt_offset * 3600, false );
        }
    } else {
